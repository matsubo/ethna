...
class Ethna_Plugin_Validator_Max_Test extends Ethna_UnitTestBase
{
    ...
    function test_max_integer()
    {
        ...
        $this->assertEqual(Ethna_Const::E_FORM_MAX_INT,$pear_error->getCode());
    ...
    function test_max_float()
    {
        ...
        $this->assertTrue(is_a($pear_error, 'Ethna_Error'));
        $this->assertEqual(Ethna_Const::E_FORM_MAX_FLOAT, $pear_error->getCode());
    ...
    function test_max_datetime()
    {
        ...
        $this->assertTrue(is_a($pear_error, 'Ethna_Error'));
        $this->assertEqual(Ethna_Const::E_FORM_MAX_DATETIME, $pear_error->getCode());
