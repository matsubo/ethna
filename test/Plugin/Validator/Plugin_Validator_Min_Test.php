...
class Ethna_Plugin_Validator_Min_Test extends Ethna_UnitTestBase
{
    ...
    function test_min_integer()
    {
        ...
        $this->assertEqual(Ethna_Const::E_FORM_MIN_INT,$pear_error->getCode());
    ...
    function test_min_float()
    {
        ...
        $this->assertTrue(is_a($pear_error, 'Ethna_Error'));
        $this->assertEqual(Ethna_Const::E_FORM_MIN_FLOAT, $pear_error->getCode());
    ...
    function test_min_datetime()
    {
        ...
        $this->assertTrue(is_a($pear_error, 'Ethna_Error'));
        $this->assertEqual(Ethna_Const::E_FORM_MIN_DATETIME, $pear_error->getCode());
