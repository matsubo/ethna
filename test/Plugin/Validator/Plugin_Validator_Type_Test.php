...
class Ethna_Plugin_Validator_Type_Test extends Ethna_UnitTestBase
{
    ...
    function test_Check_Type_Integer()
    {
        ...
        $this->assertEqual(Ethna_Const::E_FORM_WRONGTYPE_INT, $pear_error->getCode());
    ...
    function test_Check_Type_Float()
    {
        ...
        $this->assertTrue(is_a($pear_error, 'Ethna_Error'));
        $this->assertEqual(Ethna_Const::E_FORM_WRONGTYPE_FLOAT, $pear_error->getCode());
    ...
    function test_Check_Type_Boolean()
    {
        ...
        $this->assertTrue(is_a($pear_error, 'Ethna_Error'));
        $this->assertEqual(Ethna_Const::E_FORM_WRONGTYPE_BOOLEAN, $pear_error->getCode());
    ...
    { 
        ...
        $this->assertTrue(is_a($pear_error, 'Ethna_Error'));
        $this->assertEqual(Ethna_Const::E_FORM_WRONGTYPE_DATETIME, $pear_error->getCode());
