...
{
    /** @array */
    private static $error_callback_list = array();
    /**
     ...
     *  @static
     */
    public static function raiseError($message, $code = Ethna_Const::E_GENERAL)
    {
        $userinfo = null;
        if (func_num_args() > 2) {
        ...
        $error = new Ethna_Error($message, $code, Ethna_Const::ETHNA_ERROR_DUMMY, E_USER_ERROR, $userinfo, 'Ethna_Error');
        return $error;
    }
     ...
     *  @static
     */
    public static function raiseWarning($message, $code = Ethna_Const::E_GENERAL)
    {
        $userinfo = null;
        if (func_num_args() > 2) {
            $userinfo = array_slice(func_get_args(), 2);
        ...
        $error = new Ethna_Error($message, $code, Ethna_Const::ETHNA_ERROR_DUMMY, E_USER_WARNING, $userinfo, 'Ethna_Error');
        return $error;
    }
     ...
     *  @static
     */
    public static function raiseNotice($message, $code = Ethna_Const::E_GENERAL)
    {
        $userinfo = null;
        if (func_num_args() > 2) {
            $userinfo = array_slice(func_get_args(), 2);
        ...
        $error = new Ethna_Error($message, $code, Ethna_Const::ETHNA_ERROR_DUMMY, E_USER_NOTICE, $userinfo, 'Ethna_Error');
        return $error;
    }
    ...
    {
        self::$error_callback_list[] = $callback;
    }
    ...
    {
        self::$error_callback_list[] = array();
    }
